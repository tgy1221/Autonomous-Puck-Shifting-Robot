...
class Operate:
    def __init__(self, args):
        ...
        self.image_id = 0
        self.notification = 'Teleoperate the robot'
        # a 5min timer
        self.count_down = 300
    ...
    def update_keyboard(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN and event.key == pygame.K_UP:
                self.command['motion'] = [linear_velocity,0] # TODO: replace with your code to make the robot drive forward
            # drive backward
            elif event.type == pygame.KEYDOWN and event.key == pygame.K_DOWN:
                self.command['motion'] = [-linear_velocity, 0] # TODO: replace with your code to make the robot drive backward
            # turn left
            elif event.type == pygame.KEYDOWN and event.key == pygame.K_LEFT:
                self.command['motion'] = [0, angular_velocity] # TODO: replace with your code to make the robot turn left
            # drive right
            elif event.type == pygame.KEYDOWN and event.key == pygame.K_RIGHT:
                self.command['motion'] = [0,  -angular_velocity] # TODO: replace with your code to make the robot turn right
            ####################################################
            # stop
